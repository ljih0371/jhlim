...
# trigger_date = datetime.datetime.now().date()
...
outputPath1_local = f'{trigger_date}_busan_train_dataset.csv'
outputPath2_local = f'{trigger_date}_busan_test_dataset.csv'

outputPath1_blob = f'output/{trigger_date}/{trigger_date}_busan_train_dataset.csv'
outputPath2_blob = f'output/{trigger_date}/{trigger_date}_busan_test_dataset.csv'
