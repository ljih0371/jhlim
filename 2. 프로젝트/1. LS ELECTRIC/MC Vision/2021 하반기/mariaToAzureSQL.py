...
def set_line(line, result2):
    ...
    #result2 = result2.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'AMP', 'VOLT1', 'VOLT2', 'HZ1', 'HZ2', 'TYP', 'MR', 'BRAND',
    #    'BRAND_CAT', 'SIDE', 'RST', 'DEFT_TYP', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI']]
    
    if line == 'MR_1LINE':
        result2 = result2.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'AMP', 'VOLT1', 'VOLT2', 'HZ1', 'HZ2', 'TYP', 'MR', 'BRAND','BRAND_CAT', 'SIDE', 'RST', 'DEFT_TYP', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI']]

    elif (line == 'MC40a_1LINE' or line =='MC40a_2LINE') :
        result2 = result2.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'AMP', 'VOLT1', 'VOLT2', 'HZ1', 'HZ2', 'TYP', 'UA_1', 'BRAND','BRAND_CAT', 'SIDE', 'RST', 'DEFT_TYP', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI']]

    elif (line == 'MC65a_1LINE' or line =='MC100a_1LINE') :
        result2 = result2.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'AMP', 'VOLT1', 'VOLT2', 'HZ1', 'HZ2', 'TYP', 'UA_1', 'TERMINAL', 'BRAND','BRAND_CAT', 'SIDE', 'RST', 'DEFT_TYP', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI']]
...
#line_list = ['MC65a_1LINE', 'MC100a_1LINE']
